      ...
      <c:forEach items="${ model.data }" var="o" >
          ...
          <td>
          	<div class="button-group">
				<a class="button border-main" href="javascript:void(0)" onclick="changeData(this)">
					<span class="icon-edit"></span> 修改</a>
				<a style="display:none" class="button border-main" href="javascript:void(0)" onclick="saveData(this)">
...
function saveData(a) {
	...
	var $d = dialog({
		...
		title : "保存确认",
		content : "你确认要保存当前的记录吗?",
		okValue : "保存",
		ok : function(){	doSave(); },
		cancelValue : "取消",
		cancel : function(){	console.log("取消成功！"); },
	});
